% ---Script NWB_BehavioralEvents---
% Input behavioral events from TxttoMat file into NWB file
%
% From 'exportNO2NWB_main.m' in Ueli's repository
% Need to change for each patient file: tempNWB directory in first and last sections, eventsFile directory
%
% John A. Thompson & Marielle L. Darwin | July 7 2021
